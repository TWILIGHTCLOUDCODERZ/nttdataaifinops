...
import { Mail, Lock, ArrowRight, Brain, Sparkles, Shield, User, CheckCircle } from 'lucide-react';
...
export function Signup({ onToggleMode }: SignupProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col">
      <AuthNavbar currentPage="signup" onNavigate={() => onToggleMode()} />
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center min-h-[calc(100vh-12rem)]">
            ...
            <div className="flex flex-col justify-center lg:pr-8">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 leading-tight">
                Start Your Cloud<br />
                <span className="text-blue-400">Optimization Journey</span>
              </h2>
              <p className="text-slate-400 text-lg mb-8 max-w-md leading-relaxed">
                Join thousands of enterprises already saving millions with AI-powered cloud cost management.
              </p>
      ...
      {/* Signup Form - Below the image on mobile, bottom section on desktop */}
      <section className="pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md mx-auto">
          <div className="bg-slate-900/50 border border-slate-800/60 rounded-2xl p-8">
            <div className="mb-6 text-center">
              <h2 className="text-xl font-semibold text-white mb-1">Create Account</h2>
              <p className="text-slate-400 text-sm">Start your cloud optimization journey</p>
            </div>
